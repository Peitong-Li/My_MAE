...
class MaskedAutoencoderViT(nn.Module):
    ...
    def masking_mask_region(self, x, masks, mask_ratio):
        N, L, D = x.shape
    ...
    def forward_encoder(self, x, masks, mask_ratio):
        # embed patches
        ...
        if True:
            x, mask, ids_restore = self.masking_mask_region(x, masks, mask_ratio)
        else:
